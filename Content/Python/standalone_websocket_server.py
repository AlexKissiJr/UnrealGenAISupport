...
def handle_client(client_socket, client_address):
    ...
    try:
        ...
        log(f"🟢 WebSocket client connected: {client_id} from {client_address}")
        ...
        log(f"🔴 WebSocket client disconnected: {client_id}")
    except Exception as e:
...
def handle_handshake(command):
    ...
    log(f"WebSocket handshake received: {message}")
