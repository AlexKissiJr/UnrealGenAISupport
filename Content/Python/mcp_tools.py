...
class FastMCP:
    def __init__(self, handshake_key: str):
    ...
    def tool(self):
        ...
        def decorator(func):
            ...
            self.tool_descriptions[name] = func.__doc__ or ""
            return func
        return decorator
    ...
    def dispatch(self, command: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if command.get("type") == "handshake":
                return {
                    "success": True,
                    "message": f"Handshake successful with key: {self.handshake_key}"
                }
            ...
            if not tool_name:
                return {
                    "success": False,
                    "error": "Missing tool name in command"
                }
